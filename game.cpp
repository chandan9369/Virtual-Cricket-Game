...
void Game::showepitome()
{
    ...
    {
        cout << "------------------------------------------------------\n";
        cout << " ["<<i<<"]" << bowlingTeam->players[i].name<<"            "<<bowlingTeam->players[i].runs_scored<<"("<<bowlingTeam->players[i].ball_played<<")                 "<<
                      bowlingTeam->players[i].ball_bowled<<"-"<<bowlingTeam->players[i].runs_given<<"-"<<bowlingTeam->players[i].wicketsTaken<<"  \n";
    }
    cout << "========================================================\n";
    cout<<"\n\n";
    ...
    {
        cout << "------------------------------------------------------\n";
        cout << " ["<<i<<"]" << battingTeam->players[i].name<<"            "<<battingTeam->players[i].runs_scored<<"("<<battingTeam->players[i].ball_played<<")                 "<<
                      battingTeam->players[i].ball_bowled<<"-"<<battingTeam->players[i].runs_given<<"-"<<battingTeam->players[i].wicketsTaken<<"  \n";
    }
    cout << "========================================================\n";
